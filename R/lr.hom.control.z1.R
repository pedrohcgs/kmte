################################################################ This file is used to compute the linear representation of control individuals with instrument
...
# fulldata = the entire dataset subdata = sub-sample of control individuals with instrument Z
# equal to 1 dimx = #of covariates X late = local average treatment effects

lr.hom.control.z1 <- function(fulldata, subdata, dimx, late) {
