...
################################################################ Z=1, for testing the null of homogeneous conditional local average treatment effects, as
...
# equal to 1 dimx = #of covariates X late = local average treatment effects

lr.hom.treat.z1 <- function(fulldata, subdata, dimx, late) {
    ...
    if (n.sub > 0) {
        ...
        err <- (subdatakm[, 1] - latekm)/(subdatakm[, (dimfull - 1)])
