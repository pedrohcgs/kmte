...
################################################################ testing the null of homogeneous conditional local average treatment effects, as proposed in the
################################################################ paper 'Nonparametric Tests for Treatment Effect Heterogeneity with Censored data' by Sant'Anna,
################################################################ Pedro H.C. This compute ths linear representation for unconditional term with z=0
...
# equal to 0 dimx = #of covariates X
