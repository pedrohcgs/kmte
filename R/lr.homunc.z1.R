################################################################ This file is used to compute the linear representation of individuals with instrument Z=1, for
...
################################################################ Pedro H.C. This compute ths linear representation for unconditional term with z=1
...
# fulldata = the entire dataset subdata = sub-sample of individuals with instrument Z equal to 1
